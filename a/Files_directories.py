...
def main():
    ...
    #temp = [[e.get_name(), "1", str(e.get_size()), approximate_size(e.get_size())] for e in parent_directory.get_all_elements()]
    #[e.print_all_elements() for e in parent_directory.get_all_elements()]

    temp = [[e.get_name(), str(e.get_count()) + " " + str(e.get_count()), str(e.get_size()), approximate_size(e.get_size()), str(e.get_all_subdirs()), str(e.get_files()), str(e.get_subdirs())] for e in parent_directory.get_all_directories_by_name()]
